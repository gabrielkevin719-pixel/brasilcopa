...
var lr = v,
    ...
    fr = lr.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
    dr = {
        key: !0,
        ref: !0,
        __self: !0,
...
function Ls(t, e, n) {
    ...
    for (s in e) hr.call(e, s) && !dr.hasOwnProperty(s) && (i[s] = e[s]);
    if (t && t.defaultProps)
...
const Xt = v.createContext(null),
    ke = v.createContext({
        transformPagePoint: t => t,
        isStatic: !1,
        reducedMotion: "never"
    });
class pr extends v.Component {
...
const Be = typeof window < "u",
    ks = Be ? v.useLayoutEffect : v.useEffect,
    Wu = ({
        children: t,
        custom: e,
        initial: n = !0,
        ...
        const [a, l] = Fs(r), u = v.useMemo(() => mn(t), [t]), c = r && !a ? [] : u.map(Ft), h = v.useRef(!0), f = v.useRef(u), d = Fe(() => new Map), [p, m] = v.useState(u), [y, g] = v.useState(u);
        ks(() => {
        ...
        if (u !== p) {
            ...
            for (let x = 0; x < y.length; x++) {
                const w = y[x],
                    M = Ft(w);
                c.includes(M) || (b.splice(x, 0, w), T.push(w))
            }
            o === "wait" && T.length && (b = T), g(mn(b)), m(u);
            return
        }
        const {
            forceRender: P
        ...
        return G.jsx(G.Fragment, {
            children: y.map(b => {
                const x = Ft(b),
                    w = r && !a ? !1 : u === y || c.includes(x),
                    M = () => {
                        if (d.has(x)) d.set(x, !0);
                        else return;
                        let A = !0;
                        d.forEach(L => {
                            L || (A = !1)
                        }), A && (P ? .(), g(f.current), r && l ? .(), s && s())
                    };
                return G.jsx(gr, {
                    isPresent: w,
...
function Bs(t, e) {
    ...
    const i = {
        ...
        d = () => {
            ...
            n = !1, i.delta = s ? 1e3 / 60 : Math.max(Math.min(g - i.timestamp, Tr), 1), i.timestamp = g, i.isProcessing = !0, a.process(i), l.process(i), u.process(i), c.process(i), h.process(i), f.process(i), i.isProcessing = !1, n && e && (s = !1, t(d))
        },
        p = () => {
            n = !0, s = !0, i.isProcessing || t(d)
        };
    return {
        schedule: kt.reduce((g, T) => {
            const P = r[T];
            return g[T] = (b, x = !1, w = !1) => (n || p(), P.schedule(b, x, w)), g
        }, {}),
        cancel: g => {
            for (let T = 0; T < kt.length; T++) r[kt[T]].cancel(g)
        },
        state: i,
        steps: r
    }
...
const {
    ...
    state: E,
    steps: ne
} = Bs(typeof requestAnimationFrame < "u" ? requestAnimationFrame : j, !0), js = v.createContext({
    strict: !1
}), gn = {
...
const Sr = new Set(["animate", "exit", "variants", "initial", "style", "values", "variants", "transition", "transformTemplate", "custom", "inherit", "onBeforeLayoutMeasure", "onAnimationStart", "onAnimationComplete", "onUpdate", "onDragStart", "onDrag", "onDragEnd", "onMeasureDragConstraints", "onDirectionLock", "onDragTransitionEnd", "_dragX", "_dragY", "onHoverStart", "onHoverEnd", "onViewportEnter", "onViewportLeave", "globalTapTarget", "ignoreStrict", "viewport"]);
...
function Ar(t) {
    t && (Os = e => e.startsWith("on") ? !Ut(e) : t(e))
}
try {
...
function br(t, e, n) {
    const s = {};
    for (const i in t) i === "values" && typeof t.values == "object" || (Os(i) || n === !0 && Ut(i) || !e && !Ut(i) || t.draggable && i.startsWith("onDrag")) && (s[i] = t[i]);
    return s
}
...
const Oe = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"],
    Ie = ["initial", ...Oe];

function Zt(t) {
    return qt(t.animate) || Ie.some(e => bt(t[e]))
}
...
const Ne = t => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
    Rr = "framerAppearId",
    Ns = "data-" + Ne(Rr),
    {
        schedule: Ue,
...
function Er(t, e, n, s, i) {
    ...
    const {
        visualElement: a
    } = v.useContext(Yt), l = v.useContext(js), u = v.useContext(Xt), c = v.useContext(ke).reducedMotion, h = v.useRef(null);
    ...
    const f = h.current,
        d = v.useContext(Us);
    f && !f.projection && i && (f.type === "html" || f.type === "svg") && Lr(h.current, n, i, d);
    const p = v.useRef(!1);
    v.useInsertionEffect(() => {
        f && p.current && f.update(n, u)
    });
    const m = n[Ns],
        y = v.useRef(!!m && !(!((o = window.MotionHandoffIsComplete) === null || o === void 0) && o.call(window, m)) && ((r = window.MotionHasOptimisedAnimation) === null || r === void 0 ? void 0 : r.call(window, m)));
    return ks(() => {
        f && (p.current = !0, window.MotionIsMounted = !0, f.updateFeatures(), Ue.render(f.render), y.current && f.animationState && f.animationState.animateChanges())
    }), v.useEffect(() => {
...
function Lr(t, e, n, s) {
    ...
    t.projection = new n(t.latestValues, e["data-framer-portal-id"] ? void 0 : _s(t.parent)), t.projection.setOptions({
        layoutId: i,
        layout: o,
...
function _s(t) {
    if (t) return t.options.allowProjection !== !1 ? t.projection : _s(t.parent)
}
...
function Fr({
    ...
    function a(u, c) {
        ...
        if (!d && Be) {
            Br();
            const y = jr(f);
            h = y.MeasureLayout, p.visualElement = Er(i, m, f, e, y.ProjectionNode)
        }
        return G.jsxs(Yt.Provider, {
            value: p,
            children: [h && p.visualElement ? G.jsx(h, {
                visualElement: p.visualElement,
                ...f
            }) : null, n(i, u, Mr(m, p.visualElement, c), m, d, p.visualElement)]
        })
    }
...
function kr({
    ...
    const e = v.useContext(Le).id;
    return e && t !== void 0 ? e + "-" + t : t
}

function Br(t, e) {
    v.useContext(js).strict
}
...
const Or = ["animate", "circle", "defs", "desc", "ellipse", "g", "image", "line", "filter", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "rect", "stop", "switch", "symbol", "svg", "text", "tspan", "use", "view"];

function _e(t) {
    return typeof t != "string" || t.includes("-") ? !1 : !!(Or.indexOf(t) > -1 || /[A-Z]/u.test(t))
}
...
const ge = t => Array.isArray(t),
    Ir = t => !!(t && typeof t == "object" && t.mix && t.toValue),
    Nr = t => ge(t) ? t[t.length - 1] || 0 : t,
    k = t => !!(t && t.getVelocity);

function Ot(t) {
    const e = k(t) ? t.get() : t;
    return Ir(e) ? e.toValue() : e
}
...
function Ur({
    ...
    const r = {
        latestValues: _r(s, i, o, t),
        renderState: e()
    };
    return n && (r.onMount = a => n({
        props: s,
        current: a,
        ...r
    }), r.onUpdate = a => n(a)), r
...
const pt = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"],
    ...
    $s = Ws("--"),
    Kr = Ws("var(--"),
    We = t => Kr(t) ? Wr.test(t.split("/*")[0].trim()) : !1,
    Wr = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu,
    Gs = (t, e) => e && typeof t == "number" ? e.transform(t) : t,
    X = (t, e, n) => n > e ? e : n < t ? t : n,
    mt = {
...
function ze(t, {
    ...
    f.transform && (p && (d.transform = f.transform), delete f.transform), p && (i !== void 0 || o !== void 0 || d.transform) && (d.transformOrigin = to(p, i !== void 0 ? i : .5, o !== void 0 ? o : .5)), e !== void 0 && (f.x = e), n !== void 0 && (f.y = n), s !== void 0 && (f.scale = s), r !== void 0 && Qr(f, r, a, l, !1)
}
const He = () => ({
        style: {},
        transform: {},
    ...
    Xe = t => typeof t == "string" && t.toLowerCase() === "svg";
...
function Ys(t, e, n, s) {
    Hs(t, e, void 0, s);
    for (const i in e.attrs) t.setAttribute(Xs.has(i) ? i : Ne(i), e.attrs[i])
}
const _t = {};
...
function qs(t, {
    ...
    return it.has(t) || t.startsWith("origin") || (e || n !== void 0) && (!!_t[t] || t === "opacity")
}
...
function Ye(t, e, n) {
    ...
    for (const r in i)(k(i[r]) || e.style && k(e.style[r]) || qs(r, t) || ((s = n ? .getValue(r)) === null || s === void 0 ? void 0 : s.liveStyle) !== void 0) && (o[r] = i[r]);
    return o
}
    ...
    so = {
        useVisualState: Ks({
            ...
            onUpdate: ({
                ...
                r && V.read(() => {
                    no(n, s), V.render(() => {
                        ze(s, i, Xe(n.tagName), t.transformTemplate), Ys(n, s)
                    })
                })
            }
        })
...
function Js(t, e, n) {
    for (const s in e) !k(e[s]) && !qs(s, n) && (t[s] = e[s])
}
...
function ro({
    ...
    return v.useMemo(() => {
        const n = He();
        return Ge(n, e, t), Object.assign({}, n.vars, n.style)
    }, [e])
}
...
function oo(t, e) {
    const n = t.style || {},
        s = {};
    return Js(s, n, t), Object.assign(s, ro(t, e)), s
}
...
function lo(t, e, n, s) {
    const i = v.useMemo(() => {
        const o = zs();
        return ze(o, e, Xe(s), t.transformTemplate), { ...o.attrs,
            style: { ...o.style
            }
        }
    }, [e]);
...
function uo(t = !1) {
    return (n, s, i, {
        ...
        const l = (_e(n) ? lo : ao)(s, o, r, n),
            u = br(s, typeof n == "string", t),
            c = n !== v.Fragment ? { ...u,
                ...l,
                ref: i
            } : {},
            ...
            f = v.useMemo(() => k(h) ? h.get() : h, [h]);
        return v.createElement(n, { ...c,
            children: f
        })
    }
}
...
const ho = je(() => window.ScrollTimeline !== void 0);
class fo {
    constructor(e) {
    ...
    attachTimeline(e, n) {
        const s = this.animations.map(i => {
            if (ho() && i.attachTimeline) return i.attachTimeline(e);
...
const Je = t => Array.isArray(t) && typeof t[0] == "number",
    mo = {
        linearEasing: void 0
    };
...
function go(t, e) {
    ...
    return () => {
        var s;
        return (s = mo[e]) !== null && s !== void 0 ? s : n()
    }
}
const Kt = go(() => {
        try {
...
function ni(t) {
    return !!(typeof t == "function" && Kt() || !t || typeof t == "string" && (t in ve || Kt()) || Je(t) || Array.isArray(t) && t.every(ni))
}
...
function si(t, e) {
    if (t) return typeof t == "function" && Kt() ? ei(t, e) : Je(t) ? yt(t) : Array.isArray(t) ? t.map(n => si(n, e) || ve.easeOut) : ve[t]
}
const _ = {
    x: !1,
    y: !1
...
function bn(t) {
    return e => {
        e.pointerType === "touch" || ii() || t(e)
    }
}

function vo(t, e, n = {}) {
    const [s, i, o] = ri(t, n), r = bn(a => {
        const {
            target: l
        } = a, u = e(a);
...
function So(t, e, n = {}) {
    const [s, i, o] = ri(t, n), r = a => {
        const l = a.currentTarget;
        if (!Vn(a) || vt.has(l)) return;
        vt.add(l);
        const u = e(a),
            c = (d, p) => {
                window.removeEventListener("pointerup", h), window.removeEventListener("pointercancel", f), !(!Vn(d) || !vt.has(l)) && (vt.delete(l), typeof u == "function" && u(d, {
                    success: p
                }))
            },
            h = d => {
                c(d, n.useGlobalTarget || oi(l, d.target))
            },
            f = d => {
                c(d, !1)
            };
    ...
    return s.forEach(a => {
        !To(a) && a.getAttribute("tabindex") === null && (a.tabIndex = 0), (n.useGlobalTarget ? window : a).addEventListener("pointerdown", r, i), a.addEventListener("focus", u => Po(u, i), i)
    }), o
}
...
const ai = new Set(["width", "height", "top", "left", "right", "bottom", ...pt]);
let It;
...
const W = {
    now: () => (It === void 0 && W.set(E.isProcessing || vr.useManualTiming ? E.timestamp : performance.now()), It),
    set: t => {
        It = t, queueMicrotask(bo)
    }
};
...
class Vo {
    ...
    setCurrent(e) {
        this.current = e, this.updatedAt = W.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = wo(this.current))
    }
...
function xe(t, e) {
    ...
    if (Mo(n)) return n.add(e)
}

function ui(t) {
    return t.props[Ns]
}
const ci = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t,
    Ro = 1e-7,
    Eo = 12;

function Lo(t, e, n, s, i) {
    let o, r, a = 0;
    do r = e + (n - e) / 2, o = ci(r, s, i) - t, o > 0 ? n = r : e = r; while (Math.abs(o) > Ro && ++a < Eo);
    return r
}
...
const hi = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
    fi = t => e => 1 - t(1 - e),
    di = Rt(.33, 1.53, .69, .99),
    sn = fi(di),
    pi = hi(sn),
    mi = t => (t *= 2) < 1 ? .5 * sn(t) : .5 * (2 - Math.pow(2, -10 * (t - 1))),
...
const Bo = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,
    an = (t, e) => n => !!(typeof n == "string" && Bo.test(n) && n.startsWith(t) || e && !ko(n) && Object.prototype.hasOwnProperty.call(n, e)),
    xi = (t, e, n) => s => {
    ...
    nt = {
        ...
        transform: ({
            ...
            blue: n,
            alpha: s = 1
        }) => "rgba(" + ie.transform(t) + ", " + ie.transform(e) + ", " + ie.transform(n) + ", " + Tt(wt.transform(s)) + ")"
    };
...
const Te = {
    ...
    at = {
        ...
        transform: ({
            ...
            lightness: n,
            alpha: s = 1
        }) => "hsla(" + Math.round(t) + ", " + K.transform(Tt(e)) + ", " + K.transform(Tt(n)) + ", " + Tt(wt.transform(s)) + ")"
    },
    F = {
        test: t => nt.test(t) || Te.test(t) || at.test(t),
        parse: t => nt.test(t) ? nt.parse(t) : at.test(t) ? at.parse(t) : Te.parse(t),
...
function No(t) {
    var e, n;
    return isNaN(t) && typeof t == "string" && (((e = t.match(on)) === null || e === void 0 ? void 0 : e.length) || 0) + (((n = t.match(Io)) === null || n === void 0 ? void 0 : n.length) || 0) > 0
}
const Ti = "number",
    Pi = "color",
    Uo = "var",
    _o = "var(",
    Dn = "${}",
    Ko = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
...
function Ct(t) {
    const e = t.toString(),
        ...
        i = [];
    let o = 0;
    const a = e.replace(Ko, l => (F.test(l) ? (s.color.push(o), i.push(Pi), n.push(F.parse(l))) : l.startsWith(_o) ? (s.var.push(o), i.push(Uo), n.push(l)) : (s.number.push(o), i.push(Ti), n.push(parseFloat(l))), ++o, Dn)).split(Dn);
    return {
        values: n,
        split: a,
        indexes: s,
...
function Ai(t) {
    ...
    return i => {
        ...
        for (let r = 0; r < s; r++)
            if (o += e[r], i[r] !== void 0) {
                const a = n[r];
                a === Ti ? o += Tt(i[r]) : a === Pi ? o += F.transform(i[r]) : o += i[r]
            }
        return o
    }
}
...
function qo(t, e, n) {
    ...
    for (; s < t.length && !i;) {
        const o = t[s];
        typeof o == "string" && !Yo.has(o) && Ct(o).values.length && (i = t[s]), s++
    }
    if (i && n)
        for (const o of e) t[o] = bi(n, i)
}
const Mn = t => t === mt || t === S,
...
class un {
    ...
    scheduleResolve() {
        this.isScheduled = !0, this.isAsync ? (st.add(this), Se || (Se = !0, V.read(Vi), V.resolveKeyframes(wi))) : (this.readKeyframes(), this.complete())
    }
    readKeyframes() {
        const {
...
const Ci = t => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t),
    ea = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u;
...
function Di(t, e, n = 1) {
    ...
    return We(i) ? Di(i, e, n + 1) : i
}
const Mi = t => e => e.test(t),
    sa = {
        test: t => t === "auto",
        parse: t => t
    },
...
class Ei extends un {
    ...
    readKeyframes() {
        ...
        for (let l = 0; l < e.length; l++) {
            let u = e[l];
            if (typeof u == "string" && (u = u.trim(), We(u))) {
                const c = Di(u, n.current);
                c !== void 0 && (e[l] = c), l === e.length - 1 && (this.finalKeyframe = u)
            }
        }
        if (this.resolveNoneKeyframes(), !ai.has(s) || e.length !== 2) return;
        const [i, o] = e, r = Ln(i), a = Ln(o);
        if (r !== a)
            if (Mn(r) && Mn(a))
                for (let l = 0; l < e.length; l++) {
                    const u = e[l];
    ...
    resolveNoneKeyframes() {
        ...
        for (let i = 0; i < e.length; i++) Fo(e[i]) && s.push(i);
        s.length && qo(e, s, n)
    }
    measureInitialState() {
        const {
...
const Fn = (t, e) => e === "zIndex" ? !1 : !!(typeof t == "number" || Array.isArray(t) || typeof t == "string" && (Z.test(t) || t === "0") && !t.startsWith("url("));
...
function ra(t, e, n, s) {
    ...
    const o = t[t.length - 1],
        r = Fn(i, e),
        a = Fn(o, e);
    return !r || !a ? !1 : ia(t) || (n === "spring" || Ze(n)) && s
}
const oa = t => t !== null;
...
const oe = (t, e, n) => {
    ...
    ua = [Te, nt, at],
    ca = t => ua.find(e => e.test(t));

function kn(t) {
    const e = ca(t);
    if (!e) return !1;
    let n = e.parse(t);
    return e === at && (n = la(n)), n
}
const Bn = (t, e) => {
        const n = kn(t),
            s = kn(e);
        ...
        return o => (i.red = oe(n.red, s.red, o), i.green = oe(n.green, s.green, o), i.blue = oe(n.blue, s.blue, o), i.alpha = C(n.alpha, s.alpha, o), nt.transform(i))
    },
    ha = (t, e) => n => e(t(n)),
    Et = (...t) => t.reduce(ha),
...
function cn(t) {
    return typeof t == "number" ? da : typeof t == "string" ? We(t) ? Wt : F.test(t) ? Bn : ga : Array.isArray(t) ? Fi : typeof t == "object" ? F.test(t) ? Bn : pa : Wt
}

function Fi(t, e) {
    const n = [...t],
        s = n.length,
        i = t.map((o, r) => cn(o)(o, e[r]));
    return o => {
...
function pa(t, e) {
    const n = { ...t,
        ...
        s = {};
    for (const i in n) t[i] !== void 0 && e[i] !== void 0 && (s[i] = cn(t[i])(t[i], e[i]));
    return i => {
...
const ga = (t, e) => {
    const n = Z.createTransformer(e),
        s = Ct(t),
        i = Ct(e);
    return s.indexes.var.length === i.indexes.var.length && s.indexes.color.length === i.indexes.color.length && s.indexes.number.length >= i.indexes.number.length ? be.has(t) && !i.values.length || be.has(e) && !s.values.length ? fa(t, e) : Et(Fi(ma(s, i), i.values), n) : Wt(t, e)
};

function ki(t, e, n) {
    return typeof t == "number" && typeof e == "number" && typeof n == "number" ? C(t, e, n) : cn(t)(t, e)
}
const ya = 5;
...
function ji(t = D.visualDuration, e = D.bounce) {
    ...
    if (m < 1) {
        const x = we(g, m);
        P = w => {
            const M = Math.exp(-m * g * w);
            return r - M * ((p + m * g * y) / x * Math.sin(x * w) + y * Math.cos(x * w))
        }
    } else if (m === 1) P = x => r - Math.exp(-g * x) * (y + (p + g * y) * x);
    else {
        const x = g * Math.sqrt(m * m - 1);
        P = w => {
            const M = Math.exp(-m * g * w),
                A = Math.min(x * w, 300);
            return r - M * ((p + m * g * y) * Math.sinh(A) + x * y * Math.cosh(A)) / x
        }
    }
    const b = {
        ...
        toString: () => {
            const x = Math.min(ti(b), ye),
                w = ei(M => b.next(x * M).value, x, 30);
            return x + "ms " + w
        }
    };
    return b
...
function On({
    ...
    return M(0), {
        ...
        next: A => {
            let L = !1;
            return !w && x === void 0 && (L = !0, b(A), M(A)), x !== void 0 && A >= x ? w.next(A - x) : (!L && b(A), f)
        }
    }
}
const ba = Rt(.42, 0, 1, 1),
    wa = Rt(0, 0, .58, 1),
    Oi = Rt(.42, 0, .58, 1),
    ...
    Nn = t => {
        if (Je(t)) {
            ...
            const [e, n, s, i] = t;
            return Rt(e, n, s, i)
        } else if (typeof t == "string") return me(In[t] !== void 0), In[t];
        return t
    };
...
function Da(t, e, {
    ...
    const o = t.length;
    if (me(o === e.length), o === 1) return () => e[0];
...
function La(t, e) {
    return t.map(() => e || Oi).splice(0, t.length - 1)
}
...
function $t({
    ...
    const i = Va(s) ? s.map(Nn) : Nn(s),
        o = {
            done: !1,
            value: e[0]
        },
        r = Ea(n && n.length === e.length ? n : Ra(e), t),
        a = Da(r, e, {
            ease: Array.isArray(i) ? i : La(e, i)
        });
    return {
...
class hn extends Li {
    constructor(e) {
        ...
        const {
            ...
            element: i,
            keyframes: o
        } = this.options, r = i ? .KeyframeResolver || un, a = (l, u) => this.onKeyframesResolved(l, u);
    ...
    initPlayback(e) {
        const {
            ...
            repeatType: o,
            velocity: r = 0
        } = this.options, a = Ze(n) ? n : ka[n] || $t;
        let l, u;
        a !== $t && typeof e[0] != "number" && (l = Et(Ba, ki(e[0], e[1])), e = [0, 100]);
    ...
    tick(e, n = !1) {
        ...
        if (d) {
            ...
            let L = Math.floor(A),
                I = A % 1;
            !I && A >= 1 && (I = 1), I === 1 && L--, L = Math.min(L, d + 1), !!(L % 2) && (p === "reverse" ? (I = 1 - I, m && (I -= m / h)) : p === "mirror" && (b = r)), P = X(0, 1, I) * h
        }
        const x = T ? {
            done: !1,
            value: l[0]
        ...
        !T && u !== null && (w = this.speed >= 0 ? this.currentTime >= c : this.currentTime <= 0);
        const M = this.holdTime === null && (this.state === "finished" || this.state === "running" && w);
        return M && i !== void 0 && (x.value = Qt(l, this.options, i)), y && y(x.value), M && this.finish(), x
    }
    get duration() {
        const {
            resolved: e
...
const Ia = je(() => Object.hasOwnProperty.call(Element.prototype, "animate")),
    Gt = 10,
    Na = 2e4;

function Ua(t) {
    return Ze(t.type) || t.type === "spring" || !ni(t.ease)
}
...
function _a(t, e) {
    ...
    const i = [];
    let o = 0;
    for (; !s.done && o < Na;) s = n.sample(o), i.push(s.value), o += Gt;
    return {
        times: void 0,
        keyframes: i,
        duration: o - Gt,
...
class Un extends Li {
    constructor(e) {
        ...
        this.resolver = new Ei(o, (r, a) => this.onKeyframesResolved(r, a), n, s, i), this.resolver.scheduleResolve()
    }
    initPlayback(e, n) {
        let {
            duration: s = 300,
        ...
        if (typeof o == "string" && Kt() && Ka(o) && (o = Ii[o]), Ua(this.options)) {
            const {
                onComplete: h,
                onUpdate: f,
                motionValue: d,
                element: p,
                ...m
            } = this.options, y = _a(e, m);
            e = y.keyframes, e.length === 1 && (e[1] = e[0]), s = y.duration, i = y.times, o = y.ease, r = "keyframes"
        }
        const c = Oa(a.owner.current, l, e, { ...this.options,
            duration: s,
            times: i,
            ease: o
        });
        return c.startTime = u ? ? this.calcStartTime(), this.pendingTimeline ? (An(c, this.pendingTimeline), this.pendingTimeline = void 0) : c.onfinish = () => {
            const {
                onComplete: h
            } = this.options;
    ...
    stop() {
        ...
        if (this.time) {
            ...
            u.setWithVelocity(p.sample(m - Gt).value, p.sample(m).value, Gt)
        }
        const {
            onStop: l
        } = this.options;
    ...
    static supports(e) {
        ...
        return Ia() && s && ja.has(s) && !l && !u && !i && o !== "mirror" && r !== 0 && a !== "inertia"
    }
}
const Wa = {
        type: "spring",
    ...
    Ha = (t, {
        keyframes: e
    }) => e.length > 2 ? Ga : it.has(t) ? t.startsWith("scale") ? $a(e[1]) : Wa : za;
...
const fn = (t, e, n, s = {}, i, o) => r => {
    ...
    return !o && Un.supports(c) ? new Un(c) : new hn(c)
};
...
function Ni(t, e, {
    ...
    for (const h in l) {
        ...
        xe(t, h), f.start(fn(h, f, d, t.shouldReduceMotion && ai.has(h) ? {
            type: !1
        } : p, t, m));
        const y = f.animation;
        y && u.push(y)
...
function Ve(t, e, n = {}) {
    ...
    const r = i ? () => Promise.all(Ni(t, i, n)) : () => Promise.resolve(),
...
function qa(t, e, n = 0, s = 0, i = 1, o) {
    ...
    return Array.from(t.variantChildren).sort(Za).forEach((u, c) => {
        u.notify("AnimationStart", e), r.push(Ve(u, e, { ...o,
            delay: n + l(c)
...
function sl(t) {
    ...
    function r(l) {
        const {
            props: u
        } = t, c = Ui(t.parent) || {}, h = [], f = new Set;
        let d = {},
            p = 1 / 0;
        for (let y = 0; y < el; y++) {
            const g = tl[y],
                T = n[g],
                P = u[g] !== void 0 ? u[g] : c[g],
                b = bt(P),
                x = g === l ? T.isActive : null;
            x === !1 && (p = y);
            let w = P === c[g] && P !== u[g] && b;
            if (w && s && t.manuallyAnimateOnMount && (w = !1), T.protectedKeys = { ...d
                }, !T.isActive && x === null || !P && !T.prevProp || qt(P) || typeof P == "boolean") continue;
            const M = il(T.prevProp, P);
            let A = M || g === l && T.isActive && !w && b || y > p && b,
                L = !1;
            const I = Array.isArray(P) ? P : [P];
            let rt = I.reduce(i(g), {});
            x === !1 && (rt = {});
            const {
                prevResolvedValues: dn = {}
            } = T, ar = { ...dn,
                ...rt
            }, pn = B => {
                A = !0, f.has(B) && (L = !0, f.delete(B)), T.needsAnimating[B] = !0;
                const $ = t.getValue(B);
                $ && ($.liveStyle = !1)
            };
            for (const B in ar) {
                ...
                let ee = !1;
                ge($) && ge(te) ? ee = !Qs($, te) : ee = $ !== te, ee ? $ != null ? pn(B) : f.add(B) : $ !== void 0 && f.has(B) ? pn(B) : T.protectedKeys[B] = !0
            }
            T.prevProp = P, T.prevResolvedValues = rt, T.isActive && (d = { ...d,
                ...rt
            }), s && t.blockInitialAnimation && (A = !1), A && (!(w && M) || L) && h.push(...I.map(B => ({
                animation: B,
                options: {
                    type: g
                }
...
const ul = t => e => Qe(e) && t(e, Lt(e));

function Pt(t, e, n, s) {
    return Dt(t, e, ul(n), s)
}
...
class _i {
    constructor(e, n, {
        ...
        if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
                ...
                const h = ue(this.lastMoveEventInfo, this.history),
        ...
        const r = Lt(e),
            a = le(r, this.transformPagePoint),
            {
                point: l
            } = a,
            {
        ...
        c && c(e, ue(a, this.history)), this.removeListeners = Et(Pt(this.contextWindow, "pointermove", this.handlePointerMove), Pt(this.contextWindow, "pointerup", this.handlePointerUp), Pt(this.contextWindow, "pointercancel", this.handlePointerUp))
    }
    updateHandlers(e) {
        this.handlers = e
    }
...
function $n(t, e, n, s = .5) {
    t.origin = s, t.originPoint = C(e.min, e.max, t.origin), t.scale = O(n) / O(e), t.translate = C(n.min, n.max, t.origin) - t.originPoint, (t.scale >= dl && t.scale <= pl || isNaN(t.scale)) && (t.scale = 1), (t.translate >= ml && t.translate <= gl || isNaN(t.translate)) && (t.translate = 0)
}

function St(t, e, n, s) {
    $n(t.x, e.x, n.x, s ? s.originX : void 0), $n(t.y, e.y, n.y, s ? s.originY : void 0)
}
...
function Sl(t, e) {
    ...
    const s = O(t),
        i = O(e);
    return i > s ? n = ht(e.min, e.max - s, t.min) : s > i && (n = ht(t.min, t.max - i, e.min)), X(0, 1, n)
}
...
function Cl(t, e, n, s = !1) {
    ...
    for (let a = 0; a < i; a++) {
        ...
        l && l.props.style && l.props.style.display === "contents" || (s && o.options.layoutScroll && o.scroll && o !== o.root && ct(t, {
            x: -o.scroll.offset.x,
            y: -o.scroll.offset.y
        }), r && (e.x *= r.x.scale, e.y *= r.y.scale, Hi(t, r)), s && tt(o.latestValues) && ct(t, o.latestValues))
    }
...
function Xi(t, e) {
    return Gi(Vl(t.getBoundingClientRect(), e))
}
...
class Rl {
    ...
    start(e, {
        ...
        const i = c => {
            ...
            o = (c, h) => {
                ...
                if (f && !d && (this.openDragLock && this.openDragLock(), this.openDragLock = Ao(f), !this.openDragLock)) return;
                this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), U(y => {
                    ...
                    if (K.test(g)) {
                        ...
                        if (T && T.layout) {
                            const P = T.layout.layoutBox[y];
                            P && (g = O(P) * (parseFloat(g) / 100))
                        }
                    }
                    this.originPoint[y] = g
                }), p && V.postRender(() => p(c, h)), xe(this.visualElement, "transform");
                const {
                    animationState: m
                } = this.visualElement;
    ...
    updateAxis(e, n, s) {
        ...
        this.constraints && this.constraints[e] && (r = xl(r, this.constraints[e], this.elastic[e])), o.set(r)
    }
    resolveConstraints() {
        var e;
        const {
        ...
        n && ot(n) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : n && i ? this.constraints = Tl(i.layoutBox, n) : this.constraints = !1, this.elastic = bl(s), o !== this.constraints && i && this.constraints && !this.hasMutatedConstraints && U(r => {
            this.constraints !== !1 && this.getAxisMotionValue(r) && (this.constraints[r] = Al(i.layoutBox[r], this.constraints[r]))
        })
    }
    ...
    startAxisValueAnimation(e, n) {
        ...
        return xe(this.visualElement, e), s.start(fn(e, s, 0, n, this.visualElement, !1))
    }
    stopAnimation() {
...
class Ll extends J {
    constructor(e) {
        super(e), this.removeGroupControls = j, this.removeListeners = j, this.controls = new Rl(e)
    }
    mount() {
        const {
            dragControls: e
...
class Fl extends J {
    ...
    onPointerDown(e) {
        this.session = new _i(e, this.createPanHandlers(), {
...
class Bl extends v.Component {
    componentDidMount() {
        ...
        eo(jl), o && (n.group && n.group.add(o), s && s.register && i && s.register(o), o.root.didUpdate(), o.addEventListener("animationComplete", () => {
            this.safeToRemove()
...
function qi(t) {
    const [e, n] = Fs(), s = v.useContext(Le);
    return G.jsx(Bl, { ...t,
        layoutGroup: s,
        switchLayoutGroup: v.useContext(Us),
        isPresent: e,
        safeToRemove: n
    })
}
...
const Zi = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
    ...
    as = t => typeof t == "number" || S.test(t);

function Wl(t, e, n, s, i, o) {
    i ? (t.opacity = C(0, n.opacity !== void 0 ? n.opacity : 1, $l(s)), t.opacityExit = C(e.opacity !== void 0 ? e.opacity : 1, 0, Gl(s))) : o && (t.opacity = C(e.opacity !== void 0 ? e.opacity : 1, n.opacity !== void 0 ? n.opacity : 1, s));
    for (let r = 0; r < Kl; r++) {
        const a = `border${Zi[r]}Radius`;
        let l = ls(e, a),
            u = ls(n, a);
        if (l === void 0 && u === void 0) continue;
        l || (l = 0), u || (u = 0), l === 0 || u === 0 || as(l) === as(u) ? (t[a] = Math.max(C(os(l), os(u), s), 0), (K.test(u) || K.test(l)) && (t[a] += "%")) : t[a] = u
...
function zl(t, e = 0, n = 1, s = .5, i, o = t, r = t) {
...
function ds(t, e, n, s) {
    fs(t.x, e, Hl, n ? n.x : void 0, s ? s.x : void 0), fs(t.y, e, Xl, n ? n.y : void 0, s ? s.y : void 0)
}
    ...
    return class {
        constructor(r = {}, a = e ? .()) {
            this.id = Ql++, this.animationId = 0, this.children = new Set, this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
                ...
                this.projectionUpdateScheduled = !1, xt && (et.totalNodes = et.resolvedTargetDeltas = et.recalculatedProjection = 0), this.nodes.forEach(nu), this.nodes.forEach(au), this.nodes.forEach(lu), this.nodes.forEach(su), xt && window.MotionDebug.record(et)
        ...
        mount(r, a = this.root.hasTreeAnimated) {
            ...
            if (c && !c.current && c.mount(r), this.root.nodes.add(this), this.parent && this.parent.children.add(this), a && (u || l) && (this.isLayoutDirty = !0), t) {
                ...
                t(r, () => {
                    this.root.updateBlockedByResize = !0, h && h(), h = _l(f, 250), Nt.hasAnimatedSinceResize && (Nt.hasAnimatedSinceResize = !1, this.nodes.forEach(Ps))
                })
            }
            l && this.root.registerSharedNode(l, this), this.options.animate !== !1 && c && (l || u) && this.addEventListener("didUpdate", ({
                ...
                const m = this.options.transition || c.getDefaultTransition() || du,
                    {
                        onLayoutAnimationStart: y,
                        onLayoutAnimationComplete: g
                    } = c.getProps(),
                    T = !this.targetLayout || !tr(this.targetLayout, p) || d,
                    P = !f && d;
                if (this.options.layoutRoot || this.resumeFrom && this.resumeFrom.instance || P || f && (T || !this.currentAnimation)) {
                ...
                } else f || Ps(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
                this.targetLayout = p
            })
        }
        unmount() {
        ...
        willUpdate(r = !0) {
            ...
            if (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && er(this), !this.root.isUpdating && this.root.startUpdate(), this.isLayoutDirty) return;
        ...
        removeTransform(r) {
            ...
            for (let l = 0; l < this.path.length; l++) {
                ...
                const c = R(),
                    h = u.measurePageBox();
                N(c, h), ds(a, u.latestValues, u.snapshot ? u.snapshot.layoutBox : void 0, c)
            }
            return tt(this.latestValues) && ds(a, this.latestValues), a
        }
        setTargetDelta(r) {
        ...
        resolveTargetDelta(r = !1) {
            ...
            if (!(!this.layout || !(h || f))) {
                if (this.resolvedRelativeTargetAt = E.timestamp, !this.targetDelta && !this.relativeTarget) {
                    ...
                    d && d.layout && this.animationProgress !== 1 ? (this.relativeParent = d, this.forceRelativeParentToResolveTarget(), this.relativeTarget = R(), this.relativeTargetOrigin = R(), At(this.relativeTargetOrigin, this.layout.layoutBox, d.layout.layoutBox), N(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                }
                if (!(!this.relativeTarget && !this.targetDelta)) {
                    if (this.target || (this.target = R(), this.targetWithTransforms = R()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), vl(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : N(this.target, this.layout.layoutBox), Hi(this.target, this.targetDelta)) : N(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget) {
                        this.attemptToResolveRelativeTarget = !1;
                        const d = this.getClosestProjectingParent();
                        d && !!d.resumingFrom == !!this.resumingFrom && !d.options.layoutScroll && d.target && this.animationProgress !== 1 ? (this.relativeParent = d, this.forceRelativeParentToResolveTarget(), this.relativeTarget = R(), this.relativeTargetOrigin = R(), At(this.relativeTargetOrigin, this.target, d.target), N(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                    }
                    xt && et.resolvedTargetDeltas++
                }
            }
        }
        getClosestProjectingParent() {
            if (!(!this.parent || De(this.parent.latestValues) || zi(this.parent.latestValues))) return this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent()
        }
        isProjecting() {
        ...
        calcProjection() {
            ...
            const f = this.treeScale.x,
                d = this.treeScale.y;
            Cl(this.layoutCorrected, this.treeScale, this.path, l), a.layout && !a.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (a.target = a.layout.layoutBox, a.targetWithTransforms = R());
            const {
                target: p
            } = a;
            if (!p) {
                ...
                return
            }!this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (cs(this.prevProjectionDelta.x, this.projectionDelta.x), cs(this.prevProjectionDelta.y, this.projectionDelta.y)), St(this.projectionDelta, this.layoutCorrected, p, this.latestValues), (this.treeScale.x !== f || this.treeScale.y !== d || !vs(this.projectionDelta.x, this.prevProjectionDelta.x) || !vs(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", p)), xt && et.recalculatedProjection++
        }
        hide() {
            this.isVisible = !1
        }
        ...
        setAnimationOrigin(r, a = !1) {
            ...
            const f = R(),
                ...
                T = !!(m && !g && this.options.crossfade === !0 && !this.path.some(fu));
            this.animationProgress = 0;
            let P;
            this.mixTargetDelta = b => {
                const x = b / 1e3;
                Ss(h.x, r.x, x), Ss(h.y, r.y, x), this.setTargetDelta(h), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (At(f, this.layout.layoutBox, this.relativeParent.layout.layoutBox), hu(this.relativeTarget, this.relativeTargetOrigin, f, x), P && Yl(this.relativeTarget, P) && (this.isProjectionDirty = !1), P || (P = R()), N(P, this.relativeTarget)), m && (this.animationValues = c, Wl(c, u, this.latestValues, x, T, g)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = x
        ...
        startAnimation(r) {
            this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && (q(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = V.update(() => {
                Nt.hasAnimatedSinceResize = !0, this.currentAnimation = Ol(0, xs, { ...r,
                    onUpdate: a => {
        ...
        applyTransformsToTarget() {
            ...
            if (!(!a || !l || !u)) {
                if (this !== r && this.layout && u && sr(this.options.animationType, this.layout.layoutBox, u.layoutBox)) {
                    l = this.target || R();
                ...
                N(a, l), ct(a, c), St(this.projectionDeltaWithTransform, this.layoutCorrected, a, c)
            }
        }
        ...
        resetSkewAndRotation() {
            ...
            for (let c = 0; c < he.length; c++) fe(`rotate${he[c]}`, r, u, this.animationValues), fe(`skew${he[c]}`, r, u, this.animationValues);
            r.render();
        ...
        getProjectionStyles(r) {
            ...
            if (this.needsReset) return this.needsReset = !1, u.opacity = "", u.pointerEvents = Ot(r ? .pointerEvents) || "", u.transform = c ? c(this.latestValues, "") : "none", u;
            const h = this.getLead();
            if (!this.projectionDelta || !this.layout || !h.target) {
                const m = {};
                return this.options.layoutId && (m.opacity = this.latestValues.opacity !== void 0 ? this.latestValues.opacity : 1, m.pointerEvents = Ot(r ? .pointerEvents) || ""), this.hasProjected && !tt(this.latestValues) && (m.transform = c ? c({}, "") : "none", this.hasProjected = !1), m
            }
            ...
            for (const m in _t) {
                ...
                const {
                    correct: y,
                    applyTo: g
                } = _t[m], T = u.transform === "none" ? f[m] : y(f[m], h);
                if (g) {
                    const P = g.length;
                    for (let b = 0; b < P; b++) u[g[b]] = T
                } else u[m] = T
            }
            return this.options.layoutId && (u.pointerEvents = h === this ? Ot(r ? .pointerEvents) || "" : "none"), u
        }
        clearSnapshot() {
    ...
    if (t.isLead() && t.layout && n && t.hasListeners("didUpdate")) {
        ...
        if (!t.resumeFrom) {
            ...
            if (h && !h.resumeFrom) {
                ...
                if (f && d) {
                    const p = R();
                    At(p, n.layoutBox, f.layoutBox);
                    const m = R();
                    At(m, s, d.layoutBox), tr(p, m) || (c = !0), h.options.layoutRoot && (t.relativeTarget = m, t.relativeTargetOrigin = p, t.relativeParent = h)
                }
            }
        }
...
function nu(t) {
    xt && et.totalNodes++, t.parent && (t.isProjecting() || (t.isProjectionDirty = t.parent.isProjectionDirty), t.isSharedProjectionDirty || (t.isSharedProjectionDirty = !!(t.isProjectionDirty || t.parent.isProjectionDirty || t.parent.isSharedProjectionDirty)), t.isTransformDirty || (t.isTransformDirty = t.parent.isTransformDirty))
}
...
const du = {
    ...
    ws = bs("applewebkit/") && !bs("chrome/") ? Math.round : j;
...
function sr(t, e, n) {
    return t === "position" || t === "preserve-aspect" && !yl(ys(e), ys(n), .2)
}
...
class vu extends J {
    mount() {
        ...
        e && (this.unmount = vo(e, n => (Cs(this.node, n, "Start"), s => Cs(this.node, s, "End"))))
    }
    unmount() {}
}
class xu extends J {
...
class Tu extends J {
    mount() {
        ...
        e && (this.unmount = So(e, n => (Ds(this.node, n, "Start"), (s, {
            success: i
        }) => Ds(this.node, s, i ? "End" : "Cancel")), {
...
function Au({
    ...
    const s = pe.get(n),
        i = JSON.stringify(e);
    return s[i] || (s[i] = new IntersectionObserver(Su, {
        root: t,
        ...e
    })), s[i]
}
...
const Rs = ["AnimationStart", "AnimationComplete", "Update", "BeforeLayoutMeasure", "LayoutMeasure", "LayoutAnimationStart", "LayoutAnimationComplete"];
class ku {
    ...
    constructor({
        ...
        } : {}, this.renderState = u, this.parent = e, this.props = n, this.presenceContext = s, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = i, this.options = a, this.blockInitialAnimation = !!o, this.isControllingVariants = Zt(n), this.isVariantNode = Is(n), this.isVariantNode && (this.variantChildren = new Set), this.manuallyAnimateOnMount = !!(e && e.current);
        const {
            willChange: h,
            ...f
        ...
        for (const d in f) {
            const p = f[d];
            l[d] !== void 0 && k(p) && p.set(l[d], !1)
        }
    }
    mount(e) {
        this.current = e, Ms.set(e, this), this.projection && !this.projection.instance && this.projection.mount(e), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((n, s) => this.bindToMotionValue(s, n)), rr.current || Ru(), this.shouldReduceMotion = this.reducedMotionConfig === "never" ? !1 : this.reducedMotionConfig === "always" ? !0 : Ee.current, this.parent && this.parent.children.add(this), this.update(this.props, this.presenceContext)
    }
    unmount() {
        Ms.delete(this.current), this.projection && this.projection.unmount(), q(this.notifyUpdate), q(this.render), this.valueSubscriptions.forEach(e => e()), this.valueSubscriptions.clear(), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this);
        for (const e in this.events) this.events[e].clear();
    ...
    update(e, n) {
        ...
        this.prevMotionValues = Fu(this, this.scrapeMotionValuesFromProps(e, this.prevProps, this), this.prevMotionValues), this.handleChildMotionValue && this.handleChildMotionValue(), this.onUpdate && this.onUpdate(this)
    }
    getProps() {
        return this.props
    }
    ...
    readValue(e, n) {
        ...
        return i != null && (typeof i == "string" && (Ci(i) || vi(i)) ? i = parseFloat(i) : !Lu(i) && Z.test(n) && (i = bi(e, n)), this.setBaseTarget(e, k(i) ? i.get() : i)), k(i) ? i.get() : i
    }
    setBaseTarget(e, n) {
        this.baseTarget[e] = n
    }
    getBaseTarget(e) {
        ...
        if (typeof s == "string" || typeof s == "object") {
            const r = Ke(this.props, s, (n = this.presenceContext) === null || n === void 0 ? void 0 : n.custom);
            r && (i = r[e])
        }
...
class Ou extends or {
    ...
    readValueFromInstance(e, n) {
        ...
        return n = Xs.has(n) ? n : Ne(n), e.getAttribute(n)
    }
    scrapeMotionValuesFromProps(e, n, s) {
        return Zs(e, n, s)
    }
    ...
    mount(e) {
        this.isSVGTag = Xe(e.tagName), super.mount(e)
    }
}
const Iu = (t, e) => _e(t) ? new Ou(e) : new ju(e, {
